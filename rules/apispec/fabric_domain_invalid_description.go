...
func NewFabricDomainInvalidDescription() *FabricDomainInvalidDescription { return &FabricDomainInvalidDescription{} }
...
func (r *FabricDomainInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricDomainInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/admin/definitions/domains.json" }
