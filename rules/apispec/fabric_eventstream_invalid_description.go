...
func NewFabricEventstreamInvalidDescription() *FabricEventstreamInvalidDescription { return &FabricEventstreamInvalidDescription{} }

func (r *FabricEventstreamInvalidDescription) Name() string    { return "fabric_eventstream_invalid_description" }
func (r *FabricEventstreamInvalidDescription) Enabled() bool   { return true }
func (r *FabricEventstreamInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricEventstreamInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/eventstream/definitions.json" }
