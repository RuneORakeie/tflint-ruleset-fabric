...
type FabricDeploymentPipelineInvalidDisplayName struct{ tflint.DefaultRule }

func NewFabricDeploymentPipelineInvalidDisplayName() *FabricDeploymentPipelineInvalidDisplayName { return &FabricDeploymentPipelineInvalidDisplayName{} }

func (r *FabricDeploymentPipelineInvalidDisplayName) Name() string    { return "fabric_deployment_pipeline_invalid_display_name" }
func (r *FabricDeploymentPipelineInvalidDisplayName) Enabled() bool   { return true }
func (r *FabricDeploymentPipelineInvalidDisplayName) Severity() string{ return tflint.ERROR }
func (r *FabricDeploymentPipelineInvalidDisplayName) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/platform/definitions/deploymentPipelines.json" }
