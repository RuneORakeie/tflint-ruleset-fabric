...
func NewFabricWarehouseInvalidDescription() *FabricWarehouseInvalidDescription { return &FabricWarehouseInvalidDescription{} }

func (r *FabricWarehouseInvalidDescription) Name() string    { return "fabric_warehouse_invalid_description" }
func (r *FabricWarehouseInvalidDescription) Enabled() bool   { return true }
func (r *FabricWarehouseInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricWarehouseInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/warehouse/definitions.json" }

func (r *FabricWarehouseInvalidDescription) Check(runner tflint.Runner) error {
	resourceType := "fabric_warehouse"
