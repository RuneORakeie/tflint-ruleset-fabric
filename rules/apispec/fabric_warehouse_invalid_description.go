...
// FabricWarehouseInvalidDescription checks whether fabric_warehouse.description is valid
type FabricWarehouseInvalidDescription struct {
	tflint.DefaultRule
...
func (r *FabricWarehouseInvalidDescription) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *FabricWarehouseInvalidDescription) Severity() tflint.Severity {
	return tflint.ERROR
}
