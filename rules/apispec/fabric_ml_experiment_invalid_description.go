...
func NewFabricMlExperimentInvalidDescription() *FabricMlExperimentInvalidDescription { return &FabricMlExperimentInvalidDescription{} }

func (r *FabricMlExperimentInvalidDescription) Name() string    { return "fabric_ml_experiment_invalid_description" }
func (r *FabricMlExperimentInvalidDescription) Enabled() bool   { return true }
func (r *FabricMlExperimentInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricMlExperimentInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/mlExperiment/definitions.json" }

func (r *FabricMlExperimentInvalidDescription) Check(runner tflint.Runner) error {
	resourceType := "fabric_ml_experiment"
