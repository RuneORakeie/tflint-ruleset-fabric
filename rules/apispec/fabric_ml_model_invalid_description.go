...
func NewFabricMlModelInvalidDescription() *FabricMlModelInvalidDescription { return &FabricMlModelInvalidDescription{} }
...
func (r *FabricMlModelInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricMlModelInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/mlModel/definitions.json" }

func (r *FabricMlModelInvalidDescription) Check(runner tflint.Runner) error {
	resourceType := "fabric_ml_model"
