...
func NewFabricMountedDataFactoryInvalidDescription() *FabricMountedDataFactoryInvalidDescription { return &FabricMountedDataFactoryInvalidDescription{} }

func (r *FabricMountedDataFactoryInvalidDescription) Name() string    { return "fabric_mounted_data_factory_invalid_description" }
func (r *FabricMountedDataFactoryInvalidDescription) Enabled() bool   { return true }
func (r *FabricMountedDataFactoryInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricMountedDataFactoryInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/mountedDataFactory/definitions.json" }
