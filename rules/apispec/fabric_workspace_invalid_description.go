...
func NewFabricWorkspaceInvalidDescription() *FabricWorkspaceInvalidDescription { return &FabricWorkspaceInvalidDescription{} }

func (r *FabricWorkspaceInvalidDescription) Name() string    { return "fabric_workspace_invalid_description" }
func (r *FabricWorkspaceInvalidDescription) Enabled() bool   { return true }
func (r *FabricWorkspaceInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricWorkspaceInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/platform/definitions/platform.json" }
