...
func NewFabricSparkEnvironmentSettingsInvalidExecutorMemory() *FabricSparkEnvironmentSettingsInvalidExecutorMemory { return &FabricSparkEnvironmentSettingsInvalidExecutorMemory{} }

func (r *FabricSparkEnvironmentSettingsInvalidExecutorMemory) Name() string    { return "fabric_spark_environment_settings_invalid_executor_memory" }
func (r *FabricSparkEnvironmentSettingsInvalidExecutorMemory) Enabled() bool   { return true }
func (r *FabricSparkEnvironmentSettingsInvalidExecutorMemory) Severity() string{ return tflint.ERROR }
func (r *FabricSparkEnvironmentSettingsInvalidExecutorMemory) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/environment/definitions.json" }
