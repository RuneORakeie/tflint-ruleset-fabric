...
func NewFabricEnvironmentInvalidDescription() *FabricEnvironmentInvalidDescription { return &FabricEnvironmentInvalidDescription{} }

func (r *FabricEnvironmentInvalidDescription) Name() string    { return "fabric_environment_invalid_description" }
func (r *FabricEnvironmentInvalidDescription) Enabled() bool   { return true }
func (r *FabricEnvironmentInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricEnvironmentInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/environment/definitions.json" }

func (r *FabricEnvironmentInvalidDescription) Check(runner tflint.Runner) error {
	resourceType := "fabric_environment"
