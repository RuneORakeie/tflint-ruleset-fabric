...
func NewFabricApacheAirflowJobInvalidDescription() *FabricApacheAirflowJobInvalidDescription { return &FabricApacheAirflowJobInvalidDescription{} }

func (r *FabricApacheAirflowJobInvalidDescription) Name() string    { return "fabric_apache_airflow_job_invalid_description" }
func (r *FabricApacheAirflowJobInvalidDescription) Enabled() bool   { return true }
func (r *FabricApacheAirflowJobInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricApacheAirflowJobInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/apacheAirflowJob/definitions.json" }
