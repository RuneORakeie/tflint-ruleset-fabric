...
func NewFabricDigitalTwinBuilderInvalidDescription() *FabricDigitalTwinBuilderInvalidDescription { return &FabricDigitalTwinBuilderInvalidDescription{} }

func (r *FabricDigitalTwinBuilderInvalidDescription) Name() string    { return "fabric_digital_twin_builder_invalid_description" }
func (r *FabricDigitalTwinBuilderInvalidDescription) Enabled() bool   { return true }
func (r *FabricDigitalTwinBuilderInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricDigitalTwinBuilderInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/digitalTwinBuilder/definitions.json" }
