...
func NewFabricLakehouseInvalidDisplayName() *FabricLakehouseInvalidDisplayName { return &FabricLakehouseInvalidDisplayName{} }

func (r *FabricLakehouseInvalidDisplayName) Name() string    { return "fabric_lakehouse_invalid_display_name" }
func (r *FabricLakehouseInvalidDisplayName) Enabled() bool   { return true }
func (r *FabricLakehouseInvalidDisplayName) Severity() string{ return tflint.ERROR }
func (r *FabricLakehouseInvalidDisplayName) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/lakehouse/definitions.json" }
