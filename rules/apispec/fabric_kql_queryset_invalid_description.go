...
func NewFabricKQLQuerysetInvalidDescription() *FabricKQLQuerysetInvalidDescription { return &FabricKQLQuerysetInvalidDescription{} }

func (r *FabricKQLQuerysetInvalidDescription) Name() string    { return "fabric_kql_queryset_invalid_description" }
func (r *FabricKQLQuerysetInvalidDescription) Enabled() bool   { return true }
func (r *FabricKQLQuerysetInvalidDescription) Severity() string{ return tflint.ERROR }
func (r *FabricKQLQuerysetInvalidDescription) Link() string    { return "https://github.com/microsoft/fabric-rest-api-specs/tree/main/kqlQueryset/definitions.json" }
